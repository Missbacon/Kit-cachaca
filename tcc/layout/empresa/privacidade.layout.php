...
<?= template('complement/head',
    [
        'title' => $dataInfo['NAME'] . ' :: Política de Privacidade',
    ]);
?>
...
<div class="d-flex flex-column wrapper">
    ...
    <main class="flex-fill">
        <div class="container">
            ...
            <hr>
            <br>
            <p>A sua privacidade é importante para nós. É política do Kit Cachaça respeitar a sua privacidade em relação
                a qualquer informação sua que possamos coletar no site <a href=http://www.dominio.com>Kit Cachaça</a>, e
            ...
            <p>O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade
                ...
                <br>
            <h2>Política de Cookies Kit Cachaça</h2>
            <br>
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Kit Cachaça oferece no
            ...
            <ul>
                ...
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Kit Cachaça, de seus
            ...
            <p>Esta política é efetiva a partir de <strong>Junho </strong><strong>2022</strong>.</p>
            <br>
            <br>
            <br>
        </div>
